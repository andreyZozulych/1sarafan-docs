...
TSL Apps автоматически переводит все системные надписи PWA на основной язык устройства пользователя — дополнительно ничего настраивать не нужно.
...
<figure><img src="../.gitbook/assets/01-language.jpg" alt=""><figcaption></figcaption></figure>
