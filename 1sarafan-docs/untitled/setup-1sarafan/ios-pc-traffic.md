...
Даже при проливе на Android можно зацепить 3-5% iOS пользователей. На больших объёмах — это существенная упущенная выгода. Поэтому в 1SARAFAN мы реализовали решение, которое поможет не терять эти деньги.&#x20;
